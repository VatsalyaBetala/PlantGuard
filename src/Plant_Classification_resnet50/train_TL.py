...
from plant_classification_TL import PlantClassifierCNN
from data_preprocessing_TL import get_datasets
...
def main():
    ...
    optimizer = optim.Adam(model.model.fc.parameters(), lr=0.001)  # Only fine-tune the last layer
    ...
    torch.save(model.state_dict(), 'plant_disease_model_TF.pth')
